...
It applies unchanged to the pinned Vial-QMK revision and includes the existing
detector tests. Local setup is documented in
...
## 0002 — Repeat Key + Key Override weak modifiers

`0002-repeat-key-override-weak-mods.patch` backports upstream QMK commit
